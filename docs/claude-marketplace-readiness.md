...
- Submission-ready plugin payload: `57e3f13be6183b9aa9150e9f226c90c98841f8f8`,
...
| Source pinning | External sources use `url` or `git-subdir` and a full commit SHA. Automated jobs later bump the SHA and re-scan. | **Ready.** The `git-subdir` template uses `path: plugins/agent-guard` and pins reachable commit `57e3f13be6183b9aa9150e9f226c90c98841f8f8`. |
